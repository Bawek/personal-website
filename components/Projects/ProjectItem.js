...
export default function ProjectItem({
  ...
  return (
    <motion.article
      ...
      className="glass-card overflow-hidden flex flex-col group transition-all duration-300 hover:border-violet-500/40"
    >
      {/* Image with link */}
      <Link href={`/projects/${slug}`} className="relative h-48 bg-surface overflow-hidden flex-shrink-0 block">
        {hasImage ? (
          <Image
            src={backgroundImg}
            alt={title}
