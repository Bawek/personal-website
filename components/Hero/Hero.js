            ...
            >
                <div className='w-full h-screen text-center'>
                    <div
                        ...
                        >
                            <h1 className='  font-extrabold text-transparent text-6xl  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Hello, I am Baweke</h1>
                            ...
                            {/* <h2 className='text-gray-600  py-3'>Software Engineer</h2> */}
                            <div className='flex justify-between items-center m-auto max-w-[280px] py-5'>
                                ...
                                <div onClick={() => window.location.href = 'mailto:bawekeasres@gmail.com'} className='rounded-full shadow-lg shadow-gray-400 p-5 cursor-pointer hover:scale-110 ease-in duration-300'>
