...
const normalizeApiBaseUrl = (url = "/api") => {
...
export const contentAPI = {
  ...
  addTranslation: (id, translationData) =>
    api.post(`/content/${id}/translations`, translationData),
};
...
export const settingsAPI = {
  ...
  updateLanguages: (languageData) =>
    api.put("/settings/languages", languageData),
};
